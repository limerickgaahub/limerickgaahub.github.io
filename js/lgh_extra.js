// By Team / By Date tables using DATA from page
(function(){
  ...
  function toMillis(r){ return new Date((r.date||'') + 'T' + (r.time||'00:00')).getTime(); }
